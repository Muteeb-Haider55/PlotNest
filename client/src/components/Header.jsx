...
//             <span className="text-emerald-700">Nest</span>
//           </h1>
//         </Link>
//         <form
//           onSubmit={handleSubmit}
//           className="bg-emerald-100 p-3 rounded-lg flex items-center"
//         >
//           <input
...
//           <Link to="/">
//             <li className="hidden sm:inline text-emerald-700 hover:underline">
//               Home
//             </li>
//           </Link>
//           <Link to="/about">
